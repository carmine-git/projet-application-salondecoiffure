...
<body>
    ...
    ?>
    <form action="femme_form.php" method="post">
        <h1 class="titre">Choix de la prestation :</h1>
        <div class="container">
            <fieldset>
                <legend>Choisissez votre coupe</legend>
                <div>
                    <input type="radio" id="aucun" name="coupe" value=0 checked />
                    <label for="aucun">Aucun</label>
                </div>
                <div>
                    <input type="radio" id="carre" name="coupe" value="aucune" checked />
            ...
            <fieldset>
                ...
                <div>
                    <input type="radio" id="aucun" name="couleur" value=0 checked />
                    <label for="aucun">Aucun</label>
                </div>
                <div>
